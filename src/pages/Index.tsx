...
import { Grid3X3, Palette, Brain, Calculator, Crown, Zap, Music, ToggleLeft } from 'lucide-react';
...
type GameType = 'home' | 'schulte' | 'stroop' | 'hue' | 'symbolic' | 'queens' | 'impulse' | 'sequence' | 'toggle';
